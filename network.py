...
Works for ANY classification task - digits, alphabets, etc!
Just change the input/output layer sizes and training data.
"""
...
class Network(object):
    ...
    def __init__(self, sizes):
        ...
        was [784, 30, 26], then it would be a three-layer network,
        with the first layer containing 784 neurons (e.g. 28x28 pixel
        image), the second layer 30 neurons, and the third layer 26
        neurons (e.g. for 26 alphabets A-Z).
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        outputs. If ``test_data`` is provided then the network will
        be evaluated against the test data after each epoch, and
        partial progress printed out. This is useful for tracking
